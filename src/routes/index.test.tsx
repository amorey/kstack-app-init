...
// SessionProvider's listen() must resolve, otherwise it throws and the
// provider falls back to an anonymous session — which would hide the
// cloud-sync demo behind the session gate.

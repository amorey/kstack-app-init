...
export type ClusterSyncEnabledSetMutation = { clusterSyncEnabledSet: { id: string, spec: { isSyncEnabled: boolean } } };
...
export type ClustersWatchSubscription = { clustersWatch: Array<{ id: string, spec: { name: string | null, isSyncEnabled: boolean, isActive: boolean, source: { kubeconfig: { context: string } | null } }, status: { source: { kubeconfig: { cluster: string, user: string, isPresent: boolean, isDefault: boolean } | null }, server: { uid: string | null }, conditions: Array<{ type: string, status: ConditionStatus, reason: string }>, syncStatus: { lastSyncedAt: string | null, conditions: Array<{ type: string, status: ConditionStatus, reason: string }> }, cache: { exists: boolean, bytes: number } } }> };

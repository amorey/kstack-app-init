...
export type ClusterDataObjectsWatchSubscription = { clusterDataObjectsWatch: { type: ChangeType, cacheID: string, object: { uid: string, apiVersion: string, kind: string, namespace: string, name: string, creationTimestamp: string | null } } };

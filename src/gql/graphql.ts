...
export type ClusterCachedCatalogsSubscription = { clusterCachedCatalogsWatch: { type: DeltaFrameType, catalog: { id: string, cacheID: string, stats: { lastDiscoveryAt: string, resourceCount: number } | null, conditions: Array<{ type: string, reason: string, message: string, unconfirmed: boolean }> } | null } };

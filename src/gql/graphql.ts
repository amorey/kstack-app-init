...
export type ClusterConnectionEventsSubscription = { eventsWatch: { type: EventFrameType, event: { id: string, type: EventType, reason: string, message: string, count: number, firstAt: string, lastAt: string } | null } };
...
export type ClusterCachedCatalogsSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClusterCachedCatalogsSubscription = { clusterCachedCatalogsWatch: { type: DeltaFrameType, catalog: { id: string, owner: { id: string }, conditions: Array<{ type: string, reason: string, message: string, unconfirmed: boolean }> } | null } };
...
export type ClusterCachedResourcesSubscriptionVariables = Exact<{
  cacheID: string;
}>;


export type ClusterCachedResourcesSubscription = { clusterCachedResourcesWatch: { type: DeltaFrameType, resource: { id: string, spec: { apiVersion: string, resource: string } } | null } };
...
export type ClusterCachedDataKindsWatchSubscription = { clusterCachedDataKindsWatch: { type: DeltaFrameType, cacheID: string, kind: { apiVersion: string, kind: string, resource: string, scope: string, isCRD: boolean, count: number } | null } };
...
export type ClustersWatchSubscription = { clustersWatch: { type: DeltaFrameType, cluster: { id: string, deletionRequestedAt: string | null, spec: { name: string | null, syncEnabled: boolean, enabled: boolean, source: { kubeconfig: { context: string } | null } }, status: { source: { kubeconfig: { cluster: string, user: string, isPresent: boolean, isDefault: boolean } | null }, server: { uid: string | null } }, conditions: Array<{ type: string, status: ConditionStatus, reason: string, message: string, liveness: boolean, unconfirmed: boolean, transitionedAt: string }> } | null } };

export type ClusterCachesWatchSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClusterCachesWatchSubscription = { clusterCachesWatch: { type: DeltaFrameType, cache: { id: string, owner: { id: string }, spec: { serverUid: string } } | null } };

export type ClusterCacheHealthWatchSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClusterCacheHealthWatchSubscription = { clusterCacheHealthWatch: { cacheID: string, status: ConditionStatus, reason: string, totalKinds: number, unhealthyKinds: number, lastUpdateAt: string | null, lastLiveAt: string | null, unhealthyKindRefs: Array<{ apiVersion: string, resource: string }> } };
...
export const ClusterCachedCatalogsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"ClusterCachedCatalogs"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clusterCachedCatalogsWatch"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"catalog"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"owner"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}},{"kind":"Field","name":{"kind":"Name","value":"conditions"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"reason"}},{"kind":"Field","name":{"kind":"Name","value":"message"}},{"kind":"Field","name":{"kind":"Name","value":"unconfirmed"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ClusterCachedCatalogsSubscription, ClusterCachedCatalogsSubscriptionVariables>;
...
export const ClusterCachedResourcesDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"subscription","name":{"kind":"Name","value":"ClusterCachedResources"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cacheID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ObjectID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clusterCachedResourcesWatch"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"cacheID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cacheID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"type"}},{"kind":"Field","name":{"kind":"Name","value":"resource"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"spec"},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"apiVersion"}},{"kind":"Field","name":{"kind":"Name","value":"resource"}}]}}]}}]}}]}}]} as unknown as DocumentNode<ClusterCachedResourcesSubscription, ClusterCachedResourcesSubscriptionVariables>;

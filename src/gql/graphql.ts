...
export type ClusterCachedCatalogsSubscription = { clusterCachedCatalogsWatch: { type: DeltaFrameType, catalog: { id: string, cacheID: string, conditions: Array<{ type: string, reason: string, message: string, unconfirmed: boolean }> } | null } };

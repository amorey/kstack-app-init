...
export type ClusterConnectionEventsSubscription = { objectEventsWatch: { type: EventFrameType, event: { id: string, type: EventType, reason: string, message: string, count: number, firstAt: string, lastAt: string } | null } };
...
export type ClusterSyncEventsSubscription = { objectEventsWatch: { type: EventFrameType, event: { id: string, type: EventType, reason: string, message: string, count: number, firstAt: string, lastAt: string } | null } };

...
export type ClusterSyncEventsSubscription = { clusterCacheEventsWatch: { id: string, type: EventType, reason: string, message: string, count: number, firstAt: string, lastAt: string } };
...
export type ClustersWatchSubscription = { clustersWatch: { type: ChangeType, cluster: { id: string, spec: { name: string | null, syncEnabled: boolean, enabled: boolean, source: { kubeconfig: { context: string } | null } }, status: { lastConnectedAt: string | null, source: { kubeconfig: { cluster: string, user: string, isPresent: boolean, isDefault: boolean } | null }, server: { uid: string | null }, conditions: Array<{ type: string, status: ConditionStatus, reason: string, message: string, lastTransitionTime: string }> } } } };

export type ClusterCachesWatchSubscriptionVariables = Exact<{ [key: string]: never; }>;


export type ClusterCachesWatchSubscription = { clusterCachesWatch: { type: ChangeType, cache: { id: string, clusterID: string, serverUid: string, status: { lastSyncedAt: string | null, conditions: Array<{ type: string, status: ConditionStatus, reason: string, message: string }> }, stats: { exists: boolean, bytes: number, objectCount: number, kindCount: number } } } };

export type ClusterDataKindsQueryVariables = Exact<{
  id: string;
  cacheID: string;
}>;


export type ClusterDataKindsQuery = { clusterDataKinds: Array<{ apiVersion: string, kind: string, resource: string, scope: string, isCRD: boolean }> };
...
export const ClusterDataKindsDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"ClusterDataKinds"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"id"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ObjectID"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"cacheID"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ObjectID"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"clusterDataKinds"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"id"}}},{"kind":"Argument","name":{"kind":"Name","value":"cacheID"},"value":{"kind":"Variable","name":{"kind":"Name","value":"cacheID"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"apiVersion"}},{"kind":"Field","name":{"kind":"Name","value":"kind"}},{"kind":"Field","name":{"kind":"Name","value":"resource"}},{"kind":"Field","name":{"kind":"Name","value":"scope"}},{"kind":"Field","name":{"kind":"Name","value":"isCRD"}}]}}]}}]} as unknown as DocumentNode<ClusterDataKindsQuery, ClusterDataKindsQueryVariables>;

...
export type ClusterSyncEventsSubscription = { clusterCacheGVRSyncEventsWatch: { type: EventFrameType, event: { id: string, type: EventType, reason: string, message: string, count: number, firstAt: string, lastAt: string } | null } };

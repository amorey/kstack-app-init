...
const documents: Documents = {
    ...
    "\n  subscription ClusterCachedCatalogs {\n    clusterCachedCatalogsWatch {\n      type\n      catalog {\n        id\n        cacheID\n        conditions {\n          type\n          reason\n          message\n          unconfirmed\n        }\n      }\n    }\n  }\n": types.ClusterCachedCatalogsDocument,
    "\n  subscription ClusterCacheStats($id: ObjectID!, $cacheID: ObjectID!) {\n    clusterCacheStatsWatch(id: $id, cacheID: $cacheID) {\n      exists\n      bytes\n      objectCount\n      kindCount\n    }\n  }\n": types.ClusterCacheStatsDocument,
    "\n  subscription ClusterCachedResources($cacheID: ObjectID!) {\n    clusterCachedResourcesWatch(cacheID: $cacheID) {\n      type\n      resource {\n        id\n        spec {\n          apiVersion\n          resource\n        }\n      }\n    }\n  }\n": types.ClusterCachedResourcesDocument,
